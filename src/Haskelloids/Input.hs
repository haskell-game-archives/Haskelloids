...
import Graphics.HGL.Window (Event (..), Window, maybeGetWindowEvent)

-- #### Data type definitions ##################################################

data UserInput = UserInput
  { -- events that correspond to user input
...
procWindowEvs = foldl procWindowEv
